...
```{r scatter_plot experience vs. salary, fig.width=12, fig.height=8}
#Initiate ggplot
...
```{r scatter_plot2 experience vs. salary, fig.width=12, fig.height=8}
#Initiate ggplot
ggplot(data_employees, aes(x=experience, y=salary))+
  #Add geom_point
  geom_point()+
...
```{r scatter_plot3 experience vs. salary, message=FALSE, fig.width=12, fig.height=8}
...
```{r experience vs. salary by gender facet_wrap, message=FALSE, fig.width=12, fig.height=8}
ggplot(data_employees, aes(x=experience, y=salary))+
  #Add geom_point
  geom_point()+
  #Add titles
...
```{r average bike rentals per month, message=FALSE, fig.width=12, fig.height=8}
...
```{r bar chart gender and mean salary, message=FALSE, fig.width=12, fig.height=8}
#Initialize ggplot
...
```{r colored bar chart, message=FALSE, fig.width=12, fig.height=8}
#Initialize ggplot
...
```{r dsitribution of gender, message=FALSE, fig.width=12, fig.height=8}
#Initialize ggplot
...
```{r density plot salary, message=FALSE, fig.width=12, fig.height=8}
#Initialize ggplot
...
```{r density plot for salary by gender, message=FALSE, fig.width=12, fig.height=8}
#Initialize ggplot
...
```{r box plot salary across gender, message=FALSE, fig.width=12, fig.height=8}
#Initialize ggplot
