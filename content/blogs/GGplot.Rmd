...
```{r scatter_plot3 experience vs. salary, message=FALSE}
...
```{r experience vs. salary by gender facet_wrap, message=FALSE}
ggplot(data_employees, aes(x=experience, y=salary))+
  #Add geom_point
  geom_point()+
  #Add titles
...
```{r get_tfl_data, cache=TRUE, echo=FALSE, message=FALSE}
library(httr)
library(readxl)
library(lubridate)
...
```{r average bike rentals per month, message=FALSE}
...
```{r bar chart gender and mean salary, message=FALSE}
#Initialize ggplot
...
```{r colored bar chart, message=FALSE}
#Initialize ggplot
...
```{r dsitribution of gender, message=FALSE}
#Initialize ggplot
...
```{r density plot salary, message=FALSE}
#Initialize ggplot
...
```{r density plot for salary by gender, message=FALSE}
#Initialize ggplot
...
```{r box plot salary across gender, message=FALSE}
#Initialize ggplot
