...
```{r ggplot initiation, echo=FALSE, error=FALSE, results="hide"}
...
```{r scatter_plot3 experience vs. salary, echo=FALSE}
...
```{r experience vs. salary by gender facet_wrap, echo=FALSE}
ggplot(data_employees, aes(x=experience, y=salary))+
  #Add geom_point
  geom_point()+
  #Add titles
...
```{r average bike rentals per month, echo=FALSE}
...
```{r compute average salary by gender, echo=FALSE}
...
```{r bar chart gender and mean salary, echo=FALSE}
#Initialize ggplot
...
```{r colored bar chart, echo=FALSE}
#Initialize ggplot
...
```{r dsitribution of gender, echo=FALSE}
#Initialize ggplot
...
```{r density plot salary, echo=FALSE}
#Initialize ggplot
...
```{r density plot for salary by gender, echo=FALSE}
#Initialize ggplot
...
```{r box plot salary across gender, echo=FALSE}
#Initialize ggplot
...
```{r Monthly changes in TfL bike rentals, fig.width=12, fig.height=8, echo=FALSE}
